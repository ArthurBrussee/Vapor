...
namespace Vapor {
	...
	public class VaporLight : MonoBehaviour {
		...
		public void CreateShadowResources() {
			...
			m_shadowCmd.Blit(blurTemp, ShadowMap, Vapor.ShadowFilterMaterial);
			...
			m_matrixCmdBuffer.DrawMesh(Vapor.QuadMesh, Matrix4x4.identity, Vapor.ScreenShadowMaterial, 0);
